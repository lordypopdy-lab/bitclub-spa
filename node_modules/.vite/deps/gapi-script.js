//#region node_modules/gapi-script/gapiScript.js
...
(function() {
	...
	var yb = function(a, b, c) {
		...
		wb[a] = !b && wb[a] || c || (/* @__PURE__ */ new Date()).getTime();
		yb(a);
	}, Ab = function(a, b, c) {
		b && 0 < b.length && (b = zb(b), c && 0 < c.length && (b += "___" + zb(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = A(xb, "_p", B()), A(b, c, B())[a] = (/* @__PURE__ */ new Date()).getTime(), yb(a, "_p", c));
	}, zb = function(a) {
	...
	var vc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//, wc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/b\/(\d{10,21})\//, xc = function(a) {
		...
		"string" === typeof b && 254 < b.length && (b = null);
		b ?? (a = a || window.location.href, b = H(a, "authuser") || null, b ??= (b = a.match(vc)) ? b[1] : null);
		...
		b ??= (a = (a || window.location.href).match(wc)) ? a[1] : null;
		if (null == b) return null;
		b = String(b);
		21 < b.length && (b = null);
		return b;
	...
	}, Ac = V(0), Bc = V(/* @__PURE__ */ new Date(0)), Cc = V(!0), Dc = V(""), Ec = V({}), Fc = V([]), W = function(a, b) {
		if (b) {
	...
	var gd = x.crypto, hd = !1, id = 0, jd = 0, kd = 1, ld = 0, md = "", nd = function(a) {
		...
		b *= (/* @__PURE__ */ new Date()).getTime() % 1e6;
		kd = kd * b % ld;
	...
	var Hd = { se: "0" }, Id = { post: !0 }, Jd = { style: "position:absolute;top:-10000px;width:450px;margin:0px;border-style:none" }, Kd = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "), Ld = A(K, "WI", B()), Md = function(a, b, c) {
		var d;
		var e = {};
		var f = d = a;
		...
		switch (a) {
			...
			case "plusone":
				...
				g = b.db;
				d = Q();
				null == g && d && (g = d.db, g ??= d.gwidget && d.gwidget.db);
				f.db = g || void 0;
				g = b.ecp;
				d = Q();
				null == g && d && (g = d.ecp, g ??= d.gwidget && d.gwidget.ecp);
				f.ecp = g || void 0;
				delete f.href;
				break;
			case "signin": f.url = Gd();
		}
		K.ILI && (f.iloader = "1");
		...
		c._methods = n.join(",");
		return fb(e, f, c);
	}, Nd = ["style", "data-gapiscan"], Pd = function(a) {
		...
		if (d.s && a && -1 != Oa.call(b, a)) {
			if ("_renderstart" === d.s || d.s === ne + "/" + a + "::_renderstart") {
				if (d = d.a && d.a[c ? 0 : 1], b = z.getElementById(a), tc(a, 2), d && b && d.width && d.height) {
					...
					b["data-csi-wdt"] = (/* @__PURE__ */ new Date()).getTime();
				}
			}
			return !0;
		}
...
//#endregion
//#region node_modules/gapi-script/index.js
/**
...
//#endregion
export { gapi, gapiComplete, loadAuth2, loadAuth2WithProps, loadClientAuth2, loadGapiInsideDOM };
