  ...
  return (
    <Sheet open={open} onClose={onClose} title="Choose network">
      ...
      >
        ...
        />
        Ensure the network you select matches the receiving platform, or you may
        lose your assets.
      </div>
          ...
          return (
            <button
              ...
              style={{
                ...
                borderRadius: 12,
                background: "#0a0c0f",
                border: active ? "1.5px solid #22c1c3" : "1px solid #1c1f23",
                color: "#fff",
                cursor: "pointer",
            ...
            >
              ...
              <div style={{ color: "#9aa0a8", fontSize: 12, marginTop: 4 }}>
                Fee: {n.fee} {symbol} · Min {n.min} · Crediting {n.eta}
              </div>
            </button>
          );
        })}
